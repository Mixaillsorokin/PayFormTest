...
//TODO: Тесты отключены...
    @Test(enabled = false, description = "Card saved for purchases when Checkbox is active")
    ...
    @Test(enabled = false, description = "Card is not saved for purchases when Checkbox is not active")
